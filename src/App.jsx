    ...
    <main className=" min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex max-w-[920px]">
      <section className="lg:flex justify-center items-center">
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <a className="font-lexend font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg" href="https://www.webmotors.com.br/sedans" target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
          ...
          <a className="font-lexend font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhitebg" href="https://www.webmotors.com.br/suvs" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
