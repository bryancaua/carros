    ...
    <main className=" min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex">
      <section className="lg:flex justify-center items-center">
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a className="font-lexend font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-orange" href="https://www.webmotors.com.br/sedans" target="_blank">Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/suvs" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
